...
var WrappedGL = (function () {
	...
	WrappedGL.prototype.hasFloatTextureSupport = function () {
		if (this.getExtension('OES_texture_float') === null || this.getExtension('OES_texture_float_linear') === null)
			return false;
	...
	WrappedGL.prototype.rebuildTexture = function (
		...
		this.texImage2D(this.TEXTURE_2D, texture, 0, format, width, height, 0, format, type, data).setTextureFiltering(
			this.TEXTURE_2D,
			texture,
			wrapS,
			wrapT,
